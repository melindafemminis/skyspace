...
//fonction qui est appelée à chaque démarrage d'une page, 
//elle lit l'url et regarde en fonction où il faut dans le temps démarrer la musique et si c'est mute ou non.
//Cette fonction ajoute aussi le bouton du volume, en javascript.
//Il nous est arrivé que le navigateur refuse de lancer automatiquement la musique 
//à cause de la sécurité quand la page charge pour la première fois.
//Dans ce cas il suffit que l'on fasse comme si le son était mute, 
//c'est alors à l'utilisateur de démarrer la musique.
